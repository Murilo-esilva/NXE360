> [!WARNING]
This project is no longer being updated, but you’re welcome to keep using or forking it! It’s been replaced by [https://gamestacker.io/](https://gamestacker.io/), which has all the same features and way more.
